...
@Component({
  selector: 'app-comedy-category',
  templateUrl: './comedy-category.component.html',
  styleUrls: ['./comedy-category.component.css']
})
export class ComedyCategoryComponent implements OnInit {
  search:any;
  allMovies:any=[{}];
